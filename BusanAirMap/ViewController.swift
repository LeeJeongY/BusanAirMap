...
//  BusanAirMap
//
//  Created by D7703_23 on 2018. 10. 31..
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var DustMap: MKMapView!
    ...
    override func viewDidLoad() {
        ...
        let location = CLLocationCoordinate2D(latitude: 35.180000, longitude: 129.081017)
        ...
        pin.coordinate = CLLocationCoordinate2D(latitude: 35.153139, longitude: 129.063876)
        pin.title = "경남공고"
        pin.subtitle = "전포동 측정소"
        DustMap.addAnnotation(pin)
        // Do any additional setup after loading the view, typically from a nib.
        
        let a = BusanAirData(coordinate: CLLocationCoordinate2D(latitude:35.0999630, longitude: 35.0999630), title: "광복동", subtitle: "광복동 주민센터")
        let b = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.0829920, longitude: 128.9668750), title: "장림동", subtitle: "사하여성회관")
        let c = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.1460850, longitude: 128.9838270), title: "학장동", subtitle: "학장초등학교")
        let d = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.2158660, longitude: 129.0197570), title: "덕천동", subtitle: "한국환경공단")
        let e = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.1841140, longitude: 129.0786090), title: " 연산동", subtitle: "연제초등학교")
        let f = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.1303210, longitude: 129.0876850), title: "대연동", subtitle: "부산공업고등학교")
        let g = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.2752570, longitude: 129.0898810), title: "청룡동", subtitle: "청룡노포동 주민센터 옥상")
        let h = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.1530480, longitude: 129.0635640), title: "전포동", subtitle: "경남공고 옥상")
        let i = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.0597260, longitude: 129.0798400), title: "태종대", subtitle: "태종대유원지관리사무소")
        let j = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.2460560, longitude: 129.2118280), title: "기장읍", subtitle: "기장초등학교 옥상")
        let k = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.2114600, longitude: 128.9547110), title: "대저동", subtitle: "대저차량사업소 옥상")
        let l = BusanAirData(coordinate: CLLocationCoordinate2D(latitude: 35.2298390, longitude:  129.0927140), title: "부곡동", subtitle: "부곡2동 주민센터 옥상")
        ...
        DustMap.addAnnotations([a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u])
    }
